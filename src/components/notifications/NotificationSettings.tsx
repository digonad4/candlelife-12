...
import { Bell, Volume2, TestTube, Play, Settings } from 'lucide-react';
...
export const NotificationSettings = () => {
  ...
  const handleSoundToggle = (enabled: boolean) => {
    ...
    unifiedNotificationService.setSoundEnabled(enabled);
  ...
  const testSound = async () => {
    try {
      await unifiedNotificationService.testSound();
      toast({
        title: 'Som testado',
    ...
    <div className="space-y-6">
      <Tabs defaultValue="general" className="w-full">
        ...
        <TabsContent value="general" className="space-y-6">
          ...
          {/* Basic Sound Notifications Card */}
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
              ...
              <CardDescription>
                Configure os sons de notificação básicos
              </CardDescription>
            </CardHeader>
              ...
              {settings.sound && (
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Clique no botão abaixo para testar o som de notificação atual
                    </p>
                    <Button
                      onClick={testSound}
                      variant="outline"
                  ...
                  <div className="p-4 bg-muted/50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium">Personalização Avançada</span>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      Para personalizar os sons de notificação, enviar seus próprios arquivos de áudio 
                      e configurar sons específicos por tipo de notificação, acesse a aba "Sons".
                    </p>
                  </div>
                </div>
              )}
